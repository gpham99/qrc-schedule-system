          ...
          {editMode === 0 ? (
            ...
            <div className="d-flex justify-content-center p-4">
              <section>
                ...
                <p className="text-left">
                  Please select all of the disciplines you would like to be
                  listed on each cell.
                </p>
                <p className="text-left font-weight-light font-italic">
                  Reminder: Creating a new schedule skeleton clears every
                  tutor's current schedule and the master schedule.
                </p>
              </section>
            </div>
          )}
