...
from security import authenticate, identity, Authenticator
...
def check_login(username):
    try:
        ...
        in_system, group = check_user(username+EMAIL_SUFFIX)
    except:
        application.logger.debug(username + " not in system")
